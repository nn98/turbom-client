    ...
    >
      <div className="section-enter mx-auto my-auto w-full max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <div className="mt-5 grid gap-3 sm:gap-5 lg:grid-cols-[1.3fr_1fr]">
          <Card className="group relative overflow-hidden rounded-lg border-border/70 bg-surface p-4 shadow-card transition-transform duration-500 ease-out hover:-translate-y-1 sm:p-6">
            <span
              className="pointer-events-none absolute -top-3 right-2 select-none font-mono text-[72px] font-bold leading-none text-navy/[0.04] transition-colors duration-500 group-hover:text-brand/10"
              aria-hidden
            >
              {cards[0].no}
            </span>
          ...
          <div className="grid gap-3 sm:gap-5">
            {cards.slice(1).map((c) => (
              <Card
                key={c.no}
                className="group relative overflow-hidden rounded-lg border-border/70 bg-surface p-4 shadow-card transition-transform duration-500 ease-out hover:-translate-y-1"
              >
                <span
                  className="pointer-events-none absolute -top-2 right-2 select-none font-mono text-[52px] font-bold leading-none text-navy/[0.04] transition-colors duration-500 group-hover:text-brand/10"
                  aria-hidden
                >
                  {c.no}
                </span>
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-soft font-mono text-xs font-semibold text-brand">
                  {c.no}
                </span>
        ...
        <div className="mt-5 grid grid-cols-2 gap-2 sm:mt-6 sm:grid-cols-4 sm:gap-4">
          {facts.map(({ label, value, icon: Icon }) => (
            <div
              key={label}
              className="flex items-start gap-2.5 rounded-md border border-border/60 bg-surface/70 p-3"
            >
              <span className="mt-0.5 grid h-8 w-8 shrink-0 place-items-center rounded-md bg-brand-soft text-brand">
